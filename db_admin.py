...
def get_db_connection(RETHINK_DB_INSTANCE_HOST='localhost',DRIVER_PORT=28015,DATABASE='sample'):
    try:
...
def get_records(table_name=config.TABLE,phone_number=config.PHONE_NUMBER,connection=connection):
    #get_db_connection()
